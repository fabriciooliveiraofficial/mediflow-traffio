...
export const PLANS: Record<PlanId, PlanConfig> = {
    essencial: {
        ...
        highlightFeatures: [
            'Até 2 profissionais',
            '1 unidade',
            'Agenda com agendamento online pelo portal',
            'Prontuário eletrônico e receitas digitais',
            'Lembretes automáticos por WhatsApp',
            'Confirmação e pesquisa de satisfação (NPS)',
    ...
    clinica: {
        ...
        highlightFeatures: [
            ...
            'Caixa de entrada: WhatsApp, Instagram, Messenger e site',
            'Funil de acompanhamento de pacientes (CRM)',
            'Conexão com anúncios da Meta (Facebook + Instagram)',
            'Links de pagamento por cartão (Stripe) e propostas',
            'Todos os módulos de especialidade',
            'Relatórios financeiro e de marketing',
        ],
        icon: Zap,
    ...
    rede: {
        ...
        highlightFeatures: [
            ...
            '200 GB para arquivos dos pacientes',
