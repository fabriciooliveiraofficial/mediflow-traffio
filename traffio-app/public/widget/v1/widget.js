/* =============================================================================
 * Mediflow / Traffio — Widget de Agendamento Embarcável (v1)
 * -----------------------------------------------------------------------------
 ...
 * - Config (tema/idioma/FAB/pixel) resolvida no servidor a partir da key.
...
<div class="bd"></div><div class="ft"></div></div>');
    ...
    renderData() {
      ...
      this.bd.innerHTML = '<div class="q">' + T.qData + '</div>' +
      ...
      var self = this, pe = this.bd.querySelector('#mf-phone');
